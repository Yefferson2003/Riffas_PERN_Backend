...
class raffleController {
    ...
    static createRaffle = async (req : Request, res : Response) => {
        const {name, nitResponsable, nameResponsable, description, startDate, playDate, price, banerImgUrl, quantity = 1000, banerMovileImgUrl, color, contactRifero, imgIconoUrl, loteria} = req.body
        try {
    ...
    static updateRaffle = async (req : Request, res : Response) => {
        const {name, description, banerImgUrl, nitResponsable, nameResponsable, startDate, playDate, editDate, banerMovileImgUrl, color, contactRifero, imgIconoUrl, loteria} = req.body
        try {
